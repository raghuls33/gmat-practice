...
# dist/GMAT_Practice_Suite.html. POSIX sh, no dependencies, no toolchain.
#
...
SRC=src
OUT=dist
FILE=$OUT/GMAT_Practice_Suite.html
...
while IFS= read -r line || [ -n "$line" ]; do
  case $line in
    *__CSS__*)
      ...
      ;;
    *__DATA__*)
      printf '<script id="gmat-data" type="application/json">' >> "$FILE.tmp"
